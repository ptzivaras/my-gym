  ...
  return (
    <div className="home">
      <div className="top-image-container">
        <img width="200" src="https://cdn.dribbble.com/users/12332800/screenshots/20388603/new-gym-font-1.jpg" alt="Top Image" className="top-image" />
      </div>

      

      {/* Text */}
      <h1>Change Your Body, Change Your Mindset</h1>
      <h3>If it was easy, Everyone would do it</h3>
